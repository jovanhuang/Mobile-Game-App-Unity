...
/// This class is used to manage the Scene 1 transition.
/// 
/// It shows the storyline on the speech text bubble.
public class Lvl3Dialog_Scene1Manager : MonoBehaviour
{
    ...
    /// 
    /// Enable continue button for user to click.
