...
/// This class is used to manage the Scene 4.1 transition.
/// 
/// It shows the storyline on the speech text bubble.
public class Lvl3Dialog_Scene4_1Manager : MonoBehaviour
{
    ...
    /// Load Scene 4.2 of Level 3 after it has been fully loaded.
    public void ContinueHostDialogue()
    {
        ...
        {
            SceneManager.LoadScene("Lvl3_Dialog_Scene4.2");
        }
    }
}