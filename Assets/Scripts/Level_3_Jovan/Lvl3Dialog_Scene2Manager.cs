...
/// This class is used to manage the Scene 2 transition.
/// 
/// It shows the storyline on the speech text bubble.
public class Lvl3Dialog_Scene2Manager : MonoBehaviour
{
    ...
    /// 
    /// Load Scene 3.1 of Level 3.
    public void goChoiceOneDialogue()
    {
        SceneManager.LoadScene("Lvl3_Dialog_Scene3.1");
    }

    /// This method will load the scene meant for choice 2.
    /// 
    /// Load Scene 3.2 of Level 3.
    public void goChoiceTwoDialogue()
    {
        SceneManager.LoadScene("Lvl3_Dialog_Scene3.2");
    }
}