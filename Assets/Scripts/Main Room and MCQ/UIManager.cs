...
/// UIManager class handles the UI of the MCQ game
public class UIManager : MonoBehaviour {
    ...
    public enum         ResolutionScreenType   { Correct, Incorrect, FinishCorrect, FinishIncorrect }
    ...
    /// </summary>
    void DisplayResolution(ResolutionScreenType type, int score) // play
    {
    ...
    /// </summary>
    void UpdateResUI(ResolutionScreenType type, int score) // play
    {
        ...
        switch (type)
        {
            ...
            case ResolutionScreenType.Incorrect:
                ...
                uIElements.ResolutionScoreText.text = "-" + score;
                break;
            case ResolutionScreenType.FinishIncorrect:
                    Debug.Log("does it come here incorrect?");
                    uIElements.ResolutionBG.color = parameters.IncorrectBGColor;
                    uIElements.ResolutionStateInfoText.text = "WRONG!";
                    uIElements.ResolutionScoreText.text = "-" + score;
                    ...
                    break;
            case ResolutionScreenType.FinishCorrect:
                    Debug.Log("does it come here correct?");
                    uIElements.ResolutionBG.color = parameters.CorrectBGColor;
                    uIElements.ResolutionStateInfoText.text = "CORRECT!";
                    uIElements.ResolutionScoreText.text = "+" + score;
                    StartCoroutine(CalculateScore());
